 ...
 * @return {number}
 */
function findIndexNegativeValue(balance) {
 ...
 * @return {number}
 */
function calculateTotalBalance(balance) {
    let totalBalance = 0;
    for (let i = 0; i < balance.length; ++i) {
...
/**
 * @param {number[]} balance
 * @param {number} indexNegativeValue 
 * @return {number}
 */
function findMinMovesToTurnNegativeValueIntoNonnegative(balance, indexNegativeValue) {
    let minMoves = 0;
